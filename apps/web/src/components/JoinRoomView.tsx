import { Key, Network, ShieldCheck } from '@phosphor-icons/react'
  ...
  return (
    <>
      ...
      <form className="entry-form" onSubmit={submit}>
        ...
        <div className="privacy-callout"><Network /><span>认证成功后会显示房间连接模式。P2P 房间在你再次确认前不会向其他成员公布公网 IP。</span></div>

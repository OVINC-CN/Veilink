  ...
  return (
    <>
      ...
      <form className="entry-form" onSubmit={submit}>
        ...
        <label>{t(preferences.locale, 'nickname')}<input autoComplete="off" autoCapitalize="words" spellCheck="false" maxLength={64} name="nickname" type="text" value={nickname} placeholder={t(preferences.locale, 'nicknamePlaceholder')} onChange={(event) => setNickname(event.target.value)} required /></label>
